...
Only :func:`spent_instance_ids` has logic worth testing -- it parses a marker
written by another repo, so the cases below are mostly about being unsurprised by
what Girder actually returns.
"""

import pytest

from sivacor_autoscaler.signals import spent_instance_ids
